...
## Using ldply to call sppnames and create a new df element in list based on
## make.dat fn.
...
## NEW
## Biomass
## Compiling df from output.biom.list, renaming cols to stages, adding a replicate col
## and gathering into long form
